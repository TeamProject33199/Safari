...
class _FavoritesCarsState extends State<FavoritesCars> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
        stream: AppLocalization.of(context).locale.languageCode == "ar"
            ? DataBase().getFavoriteCarAr(Travelers(
                id: currentUser,
              ))
            : DataBase().getFavoriteCar(Travelers(
                id: currentUser,
              )),
          ...
          if (snapshot.hasError) {
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  var isFav = car.favCars.contains(currentUser);
                                      ...
                                      children: [
                                        IconButton(
                                          ...
                                          onPressed: (){
                                            setState(() {
                                              isFav = !isFav;
                                              AppLocalization.of(context).locale.languageCode=="ar"?deleteFavorite(car.id,currentUser)  :deleteFavorite(car.id,currentUser);
                                            });
                                          },
                                        ),
                                        Row(
  ...
  Future deleteFavorite(carId,currentUser) async {
